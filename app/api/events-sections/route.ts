...
async function ensureTable() {
  await pool.execute(`
    CREATE TABLE IF NOT EXISTS events_sections (
...
export async function GET() {
  try {
    await ensureTable();
    const [rows] = await pool.execute("SELECT * FROM events_sections");
    ...
    console.error("Events sections GET error:", error);
