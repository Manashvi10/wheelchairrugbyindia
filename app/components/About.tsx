      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            {/* Floating badge */}
            <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-slate-100">
              <p className="text-navy font-black text-2xl">Since 2009</p>
              <p className="text-slate-500 text-sm font-medium">Wheelchair Rugby in India</p>
            </div>
          </div>
